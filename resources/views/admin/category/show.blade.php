...
@section('content')
    ...
    <div class="bg-light rounded h-100 p-4">
        ...
        <table class="table">
            ...
            <tr>
                <td><a href="{{route('admin.category.edit',['id'=>$data->id])}}"class="btn btn-primary btn-sm">Edit</a></td>
            </tr>
            <tr>
                <td><a href="{{route('admin.category.destroy',['id'=>$data->id])}}"class="btn btn-danger btn-sm" onclick="return confirm('Deleting !! Are you Sure ?')">Delete</a></td>
            </tr>
